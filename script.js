$('document').ready(function(){
  $('.box6-simple-btn').click(function(){
        ...
        if( x == 'box6-simple-btn1'){
          document.getElementById('box6-simple-btn1').style.background  ='#ddd';//светлий
          document.getElementById('box6-simple-btn2').style.background ='#bbb';//темний
          document.getElementById('box6-simple-btn3').style.background ='#bbb';//темний
          ...
          document.getElementById('box6-simple-btn3').style.borderBottom='solid #000 1px';         
                      ...
                      document.getElementById('box6-simple-btn2').style.background ='#ddd';//светлий
                      document.getElementById('box6-simple-btn3').style.background ='#bbb';//темний
                      ...
                      document.getElementById('box6-simple-btn3').style.borderBottom='solid #000 1px'; 
           	        ...
           	        document.getElementById('box6-simple-btn1').style.background ='#bbb';//темний
                    document.getElementById('box6-simple-btn2').style.background ='#bbb';//темний
                    document.getElementById('box6-simple-btn3').style.background ='#ddd';//светлий
